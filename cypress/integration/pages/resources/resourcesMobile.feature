@resources
Feature: Resources page for mobile resolution
...
@mobile
Scenario Outline: Filter Resources page for mobile resolution according to "Emergency Management" and "<industry>"
